...
**Routing guard:** If a non-admin user requests an admin-scope action, do not route it to `ADMIN_MODEL` automatically. Ask for explicit admin-human confirmation first.
